...
type reconcileFun func(ctx context.Context, cluster *zookeeperv1.ZookeeperCluster, logger logr.Logger) error

//+kubebuilder:rbac:groups=zookeeper.nineinfra.tech,resources=zookeeperclusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=zookeeper.nineinfra.tech,resources=zookeeperclusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=zookeeper.nineinfra.tech,resources=zookeeperclusters/finalizers,verbs=update
...
func (r *ZookeeperClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var cluster zookeeperv1.ZookeeperCluster
...
func (r *ZookeeperClusterReconciler) reconcileClusterStatus(ctx context.Context, cluster *zookeeperv1.ZookeeperCluster, logger logr.Logger) (err error) {
	cluster.Status.Init()
...
func (r *ZookeeperClusterReconciler) reconcileHeadlessService(ctx context.Context, cluster *zookeeperv1.ZookeeperCluster, logger logr.Logger) (err error) {
...
func (r *ZookeeperClusterReconciler) reconcileService(ctx context.Context, cluster *zookeeperv1.ZookeeperCluster, logger logr.Logger) (err error) {
...
func (r *ZookeeperClusterReconciler) reconcileConfigMap(ctx context.Context, cluster *zookeeperv1.ZookeeperCluster, logger logr.Logger) (err error) {
...
func (r *ZookeeperClusterReconciler) reconcileWorkload(ctx context.Context, cluster *zookeeperv1.ZookeeperCluster, logger logr.Logger) (err error) {
	desiredSts, err := r.constructZookeeperWorkload(cluster)
	if err != nil {
		return err
	}
	...
	logger.Info("Creating a new ZookeeperCluster successfully")
	return nil
}

func (r *ZookeeperClusterReconciler) reconcileClusters(ctx context.Context, cluster *zookeeperv1.ZookeeperCluster, logger logr.Logger) error {
