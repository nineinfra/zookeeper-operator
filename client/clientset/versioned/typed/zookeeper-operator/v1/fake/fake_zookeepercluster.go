...
var zookeeperclustersResource = v1.SchemeGroupVersion.WithResource("zookeeperclusters")

var zookeeperclustersKind = v1.SchemeGroupVersion.WithKind("ZookeeperCluster")
...
func (c *FakeZookeeperClusters) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ZookeeperCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(zookeeperclustersResource, c.ns, name), &v1.ZookeeperCluster{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ZookeeperCluster), err
}

// List takes label and field selectors, and returns the list of ZookeeperClusters that match those selectors.
func (c *FakeZookeeperClusters) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ZookeeperClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(zookeeperclustersResource, zookeeperclustersKind, c.ns, opts), &v1.ZookeeperClusterList{})
	...
	list := &v1.ZookeeperClusterList{ListMeta: obj.(*v1.ZookeeperClusterList).ListMeta}
	for _, item := range obj.(*v1.ZookeeperClusterList).Items {
...
func (c *FakeZookeeperClusters) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeZookeeperClusters) Create(ctx context.Context, zookeeperCluster *v1.ZookeeperCluster, opts metav1.CreateOptions) (result *v1.ZookeeperCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(zookeeperclustersResource, c.ns, zookeeperCluster), &v1.ZookeeperCluster{})
...
func (c *FakeZookeeperClusters) Update(ctx context.Context, zookeeperCluster *v1.ZookeeperCluster, opts metav1.UpdateOptions) (result *v1.ZookeeperCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(zookeeperclustersResource, c.ns, zookeeperCluster), &v1.ZookeeperCluster{})
...
func (c *FakeZookeeperClusters) UpdateStatus(ctx context.Context, zookeeperCluster *v1.ZookeeperCluster, opts metav1.UpdateOptions) (*v1.ZookeeperCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(zookeeperclustersResource, "status", c.ns, zookeeperCluster), &v1.ZookeeperCluster{})
...
func (c *FakeZookeeperClusters) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(zookeeperclustersResource, c.ns, name, opts), &v1.ZookeeperCluster{})
...
func (c *FakeZookeeperClusters) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1.ZookeeperClusterList{})
	return err
}
...
func (c *FakeZookeeperClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ZookeeperCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(zookeeperclustersResource, c.ns, name, pt, data, subresources...), &v1.ZookeeperCluster{})
