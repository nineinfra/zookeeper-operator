...
import (
	...
	"github.com/nineinfra/zookeeper-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fe328d28.nineinfra.tech",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&zookeeperv1.ZookeeperCluster{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ZookeeperCluster")
			os.Exit(1)
		}
	}
